 ...
 * MyLine.java
 * Klasa tworząca linie dostosowane do mojego programu
 *
...
public class MyLine extends Line {
    ...
    public void setContextMenu(boolean b){
        if(b){
            ...
            contextMenu.getItems().addAll(widthStrokeMenuItem, colorStrokeMenuItem, deleteMenuItem);
    ...
    MyLine(ComboBox<String> toolComboBox, ComboBox<Double> strokeComboBox, ColorPicker colorPicker){
